...
**Table S17: Fixed effects estimates for Model 1 - High intensity distance covered per minute (Zones 4 and 5)**
...
| Origin_climateCold | 0.041 | 0.234 | 447 | 0.18 | 0.860 |
| WBGT_c | -0.182 | 0.020 | 953 | -8.90 | <0.001 |
| Time_of_dayEvening:WBGT_c | 0.007 | 0.029 | 830 | 0.24 | 0.812 |
**Supplementary Table 17:** Fixed effects estimates, standard error, degrees of freedom, t-value, and P-value for each predictor.


**Table S18: Random effects estimates for Model 1 - High intensity distance covered per minute (Zones 4 and 5)**
...
**Supplementary Table 18:** Estimated standard deviations for the random effects (grouping factor: Player_id) and the residual standard deviation.

**Table S19: Model fit statistics for Model 1 - High intensity distance covered per minute (Zones 4 and 5)**
| Metric | Value |
| :--- | :---: |
...
**Supplementary Table 19:** Key metrics used to assess and compare models fit. AIC: Akaike Information Criterion; BIC: Bayesian Information Criterion.

#### Moderate intensity distance covered per minute (Zone 3)
**Table S20: Fixed effects estimates for Model 1 - Moderate intensity distance covered per minute (Zone 3)**
| Predictor Variable | Estimate | Std. Error | Degrees of Freedom | t-value | P-value |
| :--- | :---: | :---: | :---: | :---: | :---: |
...
| Origin_climateCold | 0.753 | 0.325 | 435 | 2.32 | 0.021 |
| WBGT_c | -0.336 | 0.026 | 899 | -12.94 | <0.001 |
| Time_of_dayEvening:WBGT_c | 0.026 | 0.037 | 788 | 0.70 | 0.486 |
**Supplementary Table 20:** Fixed effects estimates, standard error, degrees of freedom, t-value, and P-value for each predictor.

**Table S21: Random effects estimates for Model 1 - Moderate intensity distance covered per minute (Zone 3)**
| Random Effect Group | Parameter Type | Estimate (Std.Dev. or Residual Std.Dev.) |
| :--- | :---: | :---: |
| Player_id | sd__(Intercept) | 2.69 |
| Residual | sd__Observation | 1.89 |

**Supplementary Table 21:** Estimated standard deviations for the random effects (grouping factor: Player_id) and the residual standard deviation.

**Table S22: Model fit statistics for Model 1 - Moderate intensity distance covered per minute (Zone 3)**
| Metric | Value |
| :--- | :---: |
...
**Supplementary Table 22:** Key metrics used to assess and compare models fit. AIC: Akaike Information Criterion; BIC: Bayesian Information Criterion.

#### Low intensity distance covered per minute (Zones 1 and 2)
**Table S23: Fixed effects estimates for Model 1 - Low intensity distance covered per minute (Zones 1 and 2)**
| Predictor Variable | Estimate | Std. Error | Degrees of Freedom | t-value | P-value |
| :--- | :---: | :---: | :---: | :---: | :---: |
...
| Origin_climateCold | 2.232 | 0.593 | 433 | 3.76 | <0.001 |
| WBGT_c | -0.631 | 0.051 | 935 | -12.44 | <0.001 |
| Time_of_dayEvening:WBGT_c | 0.398 | 0.072 | 810 | 5.52 | <0.001 |
**Supplementary Table 23:** Fixed effects estimates, standard error, degrees of freedom, t-value, and P-value for each predictor.

**Table S24: Random effects estimates for Model 1 - Low intensity distance covered per minute (Zones 1 and 2)**
| Random Effect Group | Parameter Type | Estimate (Std.Dev. or Residual Std.Dev.) |
| :--- | :---: | :---: |
| Player_id | sd__(Intercept) | 4.80 |
| Residual | sd__Observation | 3.75 |

**Supplementary Table 24:** Estimated standard deviations for the random effects (grouping factor: Player_id) and the residual standard deviation.

**Table S25: Model fit statistics for Model 1 - Low intensity distance covered per minute (Zones 1 and 2)**
| Metric | Value |
| :--- | :---:|
...
**Supplementary Table 25:** Key metrics used to assess and compare models fit. AIC: Akaike Information Criterion; BIC: Bayesian Information Criterion.

#### Total distance covered per minute
**Table S26: Fixed effects estimates for Model 1 - Total distance covered per minute**
| Predictor Variable | Estimate | Std. Error | Degrees of Freedom | t-value | P-value |
| :--- | :---: | :---: | :---: | :---: | :---: |
...
| Origin_climateCold | 3.008 | 0.847 | 441 | 3.55 | <0.001 |
| WBGT_c | -1.153 | 0.067 | 897 | -17.20 | <0.001 |
| Time_of_dayEvening:WBGT_c | 0.421 | 0.094 | 789 | 4.46 | <0.001 |
**Supplementary Table 26:** Fixed effects estimates, standard error, degrees of freedom, t-value, and P-value for each predictor.

**Table S27: Random effects estimates for Model 1 - Total distance covered per minute**
| Random Effect Group | Parameter Type | Estimate (Std.Dev. or Residual Std.Dev.) |
| :--- | :---: | :---: |
| Player_id | sd__(Intercept) | 7.04 |
| Residual | sd__Observation | 4.85 |

**Supplementary Table 27:** Estimated standard deviations for the random effects (grouping factor: Player_id) and the residual standard deviation.

**Table S28: Model fit statistics for Model 1 - Total distance covered per minute**
| Metric | Value |
| :--- | :---: |
...
**Supplementary Table 28:** Key metrics used to assess and compare models fit. AIC: Akaike Information Criterion; BIC: Bayesian Information Criterion.

### MODEL 2
#### High intensity distance covered per minute (Zones 4 and 5)
**Table S29: Fixed effects estimates for Model 2 - High intensity distance covered per minute (Zones 4 and 5)**
| Predictor Variable | Estimate | Std. Error | Degrees of Freedom | t-value | P-value |
| :--- | :---: | :---: | :---: | :---: | :---: |
...
| Origin_climateCold | -0.008 | 0.234 | 448 | -0.03 | 0.973 |
...
**Supplementary Table 29:** Fixed effects estimates, standard error, degrees of freedom, t-value, and P-value for each predictor.

**Table S30: Random effects estimates for Model 2 - High intensity distance covered per minute (Zones 4 and 5)**
| Random Effect Group | Parameter Type | Estimate (Std.Dev. or Residual Std.Dev.) |
| :--- | :---: | :---: |
| Player_id | sd__(Intercept) | 1.88 |
| Residual | sd__Observation | 1.52 |
...
**Table S31: Model fit statistics for Model 2 - High intensity distance covered per minute (Zones 4 and 5)**
| Metric | Value |
| :--- | :---:|
...
**Supplementary Table 31:** Key metrics used to assess and compare models fit. AIC: Akaike Information Criterion; BIC: Bayesian Information Criterion.

#### Moderate intensity distance covered per minute (Zone 3)
**Table S32: Fixed effects estimates for Model 2 - Moderate intensity distance covered per minute (Zone 3)**
| Predictor Variable | Estimate | Std. Error | Degrees of Freedom | t-value | P-value |
| :--- | :---: | :---: | :---: | :---: | :---: |
...
| Origin_climateCold | 0.754 | 0.326 | 435 | 2.31 | 0.021 |
...
**Supplementary Table 32:** Fixed effects estimates, standard error, degrees of freedom, t-value, and P-value for each predictor.

**Table S33: Random effects estimates for Model 2 - Moderate intensity distance covered per minute (Zone 3)**
| Random Effect Group | Parameter Type | Estimate (Std.Dev. or Residual Std.Dev.) |
| :--- | :---: | :---: |
| Player_id | sd__(Intercept) | 2.70 |
| Residual | sd__Observation | 1.89 |

**Supplementary Table 33:** Estimated standard deviations for the random effects (grouping factor: Player_id) and the residual standard deviation.

**Table S34: Model fit statistics for Model 2 - Moderate intensity distance covered per minute (Zone 3)**
| Metric | Value |
| :--- | :---: |
| Conditional R-squared | 0.797 |
...
**Supplementary Table 34:** Key metrics used to assess and compare models fit. AIC: Akaike Information Criterion; BIC: Bayesian Information Criterion.

#### Low intensity distance covered per minute (Zones 1 and 2)
**Table S35: Fixed effects estimates for Model 2 - Low intensity distance covered per minute (Zones 1 and 2)**
| Predictor Variable | Estimate | Std. Error | Degrees of Freedom | t-value | P-value |
| :--- | :---: | :---: | :---: | :---: | :---: |
...
| Origin_climateCold | 2.358 | 0.583 | 439 | 4.04 | <0.001 |
...
**Supplementary Table 35:** Fixed effects estimates, standard error, degrees of freedom, t-value, and P-value for each predictor.

**Table S36: Random effects estimates for Model 2 - Low intensity distance covered per minute (Zones 1 and 2)**
| Random Effect Group | Parameter Type | Estimate (Std.Dev. or Residual Std.Dev.) |
| :--- | :---: | :---: |
| Player_id | sd__(Intercept) | 4.71 |
| Residual | sd__Observation | 3.71 |

**Supplementary Table 36:** Estimated standard deviations for the random effects (grouping factor: Player_id) and the residual standard deviation.

**Table S37: Model fit statistics for Model 2 - Low intensity distance covered per minute (Zones 1 and 2)**
| Metric | Value |
| :--- | :---: |
...
**Supplementary Table 37:** Key metrics used to assess and compare models fit. AIC: Akaike Information Criterion; BIC: Bayesian Information Criterion.

#### Total distance covered per minute
**Table S38: Fixed effects estimates for Model 2 - Total distance covered per minute**
| Predictor Variable | Estimate | Std. Error | Degrees of Freedom | t-value | P-value |
| :--- | :---: | :---: | :---: | :---: | :---: |
...
| Origin_climateCold | 3.080 | 0.844 | 444 | 3.65 | <0.001 |
...
**Supplementary Table 38:** Fixed effects estimates, standard error, degrees of freedom, t-value, and P-value for each predictor.

**Table S39: Random effects estimates for Model 2 - Total distance covered per minute**
| Random Effect Group | Parameter Type | Estimate (Std.Dev. or Residual Std.Dev.) |
| :--- | :---: | :---: |
| Player_id | sd__(Intercept) | 7.01 |
| Residual | sd__Observation | 4.84 |

**Supplementary Table 39:** Estimated standard deviations for the random effects (grouping factor: Player_id) and the residual standard deviation.

**Table S40: Model fit statistics for Model 2 - Total distance covered per minute**
| Metric | Value |
| :--- | :---: |
...
**Supplementary Table 40:** Key metrics used to assess and compare models fit. AIC: Akaike Information Criterion; BIC: Bayesian Information Criterion.

## Assumptions checks of discarded models (Model 3 and 4)

### MODEL 3
#### High intensity distance covered per minute (Zones 4 and 5)
**Table S41: Multicollinearity diagnosis**
| Predictor | VIF | VIF 95% CI | Increased SE | Tolerance | Tolerance 95% CI |
| :--- | :---: | :---: | :---: | :---: | :---: |
...
**Supplementary Table 41:** Results of the multicollinearity diagnosis for model 3 and and the outcome variable Low intensity distance covered per minute. Variance Inflation Factor (VIF), Increased Standard Error, and Tolerance values for each predictor in the model. These metrics assess the degree of multicollinearity among the continuous predictor variables. VIF > 10 indicates high multicollinearity and VIF > 5 indicates moderate multicollinearity.


#### Moderate intensity distance covered per minute (Zones 3) 
**Table S42: Multicollinearity diagnosis**
| Predictor | VIF | VIF 95% CI | Increased SE | Tolerance | Tolerance 95% CI |
| :--- | :---: | :---: | :---: | :---: | :---: |
...
**Supplementary Table 42:** Results of the multicollinearity diagnosis for model 3 and and the outcome variable Low intensity distance covered per minute. Variance Inflation Factor (VIF), Increased Standard Error, and Tolerance values for each predictor in the model. These metrics assess the degree of multicollinearity among the continuous predictor variables. VIF > 10 indicates high multicollinearity and VIF > 5 indicates moderate multicollinearity.

#### Low intensity distance covered per minute (Zones 1 and 2)
**Table S43: Multicollinearity diagnosis**
| Predictor | VIF | VIF 95% CI | Increased SE | Tolerance | Tolerance 95% CI |
| :--- | :---: | :---: | :---: | :---: | :---: |
...
**Supplementary Table 43:** Results of the multicollinearity diagnosis for model 3 and and the outcome variable Low intensity distance covered per minute. Variance Inflation Factor (VIF), Increased Standard Error, and Tolerance values for each predictor in the model. These metrics assess the degree of multicollinearity among the continuous predictor variables. VIF > 10 indicates high multicollinearity and VIF > 5 indicates moderate multicollinearity.

#### Total distance covered per minute
**Table S44: Multicollinearity diagnosis**
| Predictor | VIF | VIF 95% CI | Increased SE | Tolerance | Tolerance 95% CI |
| :--- | :---: | :---: | :---: | :---: | :---: |
...
**Supplementary Table 44:** Results of the multicollinearity diagnosis for model 3 and and the outcome variable Low intensity distance covered per minute. Variance Inflation Factor (VIF), Increased Standard Error, and Tolerance values for each predictor in the model. These metrics assess the degree of multicollinearity among the continuous predictor variables. VIF > 10 indicates high multicollinearity and VIF > 5 indicates moderate multicollinearity.

### MODEL 4
#### High intensity distance covered per minute (Zones 4 and 5) 
**Table S45: Multicollinearity diagnosis**
| Predictor | VIF | VIF 95% CI | Increased SE | Tolerance | Tolerance 95% CI |
| :--- | :---: | :---: | :---: | :---: | :---: |
...
**Supplementary Table 45:** Results of the multicollinearity diagnosis for model 4 and and the outcome variable Low intensity distance covered per minute. Variance Inflation Factor (VIF), Increased Standard Error, and Tolerance values for each predictor in the model. These metrics assess the degree of multicollinearity among the continuous predictor variables. VIF > 10 indicates high multicollinearity and VIF > 5 indicates moderate multicollinearity.

#### Moderate intensity distance covered per minute (Zones 3) 
**Table S46: Multicollinearity diagnosis**
| Predictor | VIF | VIF 95% CI | Increased SE | Tolerance | Tolerance 95% CI |
| :--- | :---: | :---: | :---: | :---: | :---: |
...
**Supplementary Table 46:** Results of the multicollinearity diagnosis for model 4 and and the outcome variable Low intensity distance covered per minute. Variance Inflation Factor (VIF), Increased Standard Error, and Tolerance values for each predictor in the model. These metrics assess the degree of multicollinearity among the continuous predictor variables. VIF > 10 indicates high multicollinearity and VIF > 5 indicates moderate multicollinearity.

#### Low intensity distance covered per minute (Zones 1 and 2)
**Table S47: Multicollinearity diagnosis**
| Predictor | VIF | VIF 95% CI | Increased SE | Tolerance | Tolerance 95% CI |
| :--- | :---: | :---: | :---: | :---: | :---: |
...
**Supplementary Table 47:** Results of the multicollinearity diagnosis for model 4 and and the outcome variable Low intensity distance covered per minute. Variance Inflation Factor (VIF), Increased Standard Error, and Tolerance values for each predictor in the model. These metrics assess the degree of multicollinearity among the continuous predictor variables. VIF > 10 indicates high multicollinearity and VIF > 5 indicates moderate multicollinearity.

#### Total distance covered per minute
**Table S48: Multicollinearity diagnosis**
| Predictor | VIF | VIF 95% CI | Increased SE | Tolerance | Tolerance 95% CI |
| :--- | :---: | :---: | :---: | :---: | :---: |
...
**Supplementary Table 48:** Results of the multicollinearity diagnosis for model 4 and and the outcome variable Low intensity distance covered per minute. Variance Inflation Factor (VIF), Increased Standard Error, and Tolerance values for each predictor in the model. These metrics assess the degree of multicollinearity among the continuous predictor variables. VIF > 10 indicates high multicollinearity and VIF > 5 indicates moderate multicollinearity.
...
**Supplementary Table 49:** Kolmogorov-Smirnov test results to check the assumption of normality for both the model residuals and the random effects. The table shows the D statistic and the p-value for each test.
...
**Supplementary Table 50:** Kolmogorov-Smirnov test results to check the assumption of normality for both the model residuals and the random effects. The table shows the D statistic and the p-value for each test.
